describe("About Objects", function () {
  ...
  it("should know properties that are functions act like methods", function () {
    //sets megalomaniac battlecry to a function of noOfBrains
    var megalomaniac = {
      mastermind : "Brain",
      henchman: "Pinky",
  ...
  it("should use prototype to add to all objects", function () {
      ...
      //only defined red for colouredCircle, so simpleCircle is undefined
      ...
      //prototype allows describe to function for both objects, so it gets each
      //objects value (10, and 5 respectively) and returns the correct sentence
