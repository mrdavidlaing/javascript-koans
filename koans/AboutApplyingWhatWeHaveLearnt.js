...
describe("About Applying What We Have Learnt", function() {
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    ...
    var sumOfMultiples = function(number) {
      return _(_.range(0, 1000, number)).reduce(function(memo, x) { return memo + x})
    }
    var sum = sumOfMultiples(3) + sumOfMultiples(5) - sumOfMultiples(3*5);    /* try chaining range() and reduce() */
