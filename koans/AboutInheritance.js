...
Object.prototype.beget = function () {
  function F() {}
  F.prototype = this; // как это можно обозвать?
  return new F();
} // создаём на объекте(в js всё является объектами) новое свойство, в которое записываем функцию создающую новый экземпляр самой себя
